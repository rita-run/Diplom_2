...
public class UserEmailUpdateTest {
    String email = "harry-potter@yandex.ru";
    String password = "password";
    String name = "harry";
    String emailUpdate = "{\"email\": \"ron_weasley@yandex.ru\"}";
    String newEmail = "ron_weasley@yandex.ru";
    ...
    public void deleteUser() {
        ...
        UserLogin userLogin = new UserLogin(newEmail, password);
